...
export default function SupportPage() {
    ...
    useEffect(() => {
        const unsub = onSupportMessage((msg) => {
            ...
            if (active && msg.supportRequestId === active.id) {
                ...
                // Zero out unread for this request
                setRequests(prev =>
                    prev.map(r =>
                ...
                // Increment unread badge for the request
                setRequests(prev =>
                    prev.map(r =>
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            // Add optimistically
            setMessages(prev => [...prev, { ...res.data, isMine: true, senderName: 'Ben', senderRole: 'Client' }]);
            setNewMsg('');
        } catch {
            // ignore
        } finally {
                ...
                <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    {!activeRequest ? (
                        ...
                        <>
                            ...
                            {/* Request Description */}
                            <Box sx={{ px: 3, py: 1.5, bgcolor: 'primary.50', borderBottom: 1, borderColor: 'divider' }}>
